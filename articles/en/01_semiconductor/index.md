...
- **If you want a physics-first understanding**  
  → 01 → 06 → 07  

- **If you want hands-on ASIC / OpenLane practice**  
  → 12 → 09 → 10 → 11 → 13 → 14  

- **If you want to understand the design philosophy**  
  → 06 → 07 → 14  

---

## 🎯 Core Questions Addressed in This Series
...
All of these questions converge on a single theme:
...
`01_Semiconductor` serves as a **starting point for viewing semiconductor technology  
not as isolated techniques, but as a coherent design framework**.

It is intended to be read in conjunction with later directories  
covering control, SystemDK, and educational toolchains.
